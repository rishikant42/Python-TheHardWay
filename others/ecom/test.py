...
pincodes_url = "http://staging.ecomexpress.in/apiv2/pincodes/"
...
r = requests.post(url=pincodes_url, data=data)
...
awb_number = str(ecom_express_data["awb"][0])
...
details = {"ECOMEXPRESS-OBJECTS": {
    "SHIPMENT": {
        ...
        "REVPICKUP_ADDRESS2": "Test Address 1",
...
ecom_express_data = r.json()
print json.dumps(ecom_express_data, indent=2)

abc = ecom_express_data.get("RESPONSE-OBJECTS").get("AIRWAYBILL-OBJECTS").get("AIRWAYBILL")
xyz = ecom_express_data.get("RESPONSE-OBJECTS").get("RESPONSE-COMMENT")

print "Awb: {}".format(abc.get("airwaybill_number"))
print "success: {}".format(abc.get("success"))
print "order_id: {}".format(abc.get("order_id"))
print "Comment: {}".format(xyz)
