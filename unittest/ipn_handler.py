...
class IpnHandler():
    ...
    def __init__(self, body, headers):
        ...
        self._seller_id = self._message.get('SellerId')
    ...
    def to_dict(self):
        """Retuns notification message as Dict"""
        return PaymentResponse(self._xml).to_dict()

    def get_signature(self):
        """Returns signature sent by amazon server"""
        return str(self._signature)

    def get_seller_id(self):
        """Returns seller-id of order"""
        return str(self._seller_id)

    def get_trigger_timestamp(self):
        """Returns webhook trigger timestamp"""
